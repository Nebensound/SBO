...
* stem:[R_"bem"] die Bemessungsradlast (dynamisch)
* stem:[R_"stat"] die statische Radlast
* stem:[phi(V)] der geschwindigkeitsabhängige Dynamikfaktor

Die anzusetzenden Faktoren stem:[phi(V)] sind im Abschnitt <<geschwindigkeitsklassen_v,Geschwindigkeitsklassen (V)>> definiert.
...
* Standardbetrieb der SBO-{spurweite}
...
bewusste Festlegung und Nachweis der Eignung des Streckenabschnitts.
