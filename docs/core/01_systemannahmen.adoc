...
[IMPORTANT]
====
Anlagen und Fahrzeuge, die für Personenverkehr genutzt werden sollen, MÜSSEN explizit dafür freigegeben werden. Eine Freigabe für Güterverkehr ist nicht ausreichend.
====
...
Abweichungen von den Grenzwerten dieser Spezifikation MÜSSEN durch:

* Berechnung mit erhöhten Sicherheitsfaktoren, oder
* Messung unter realistischen Bedingungen, oder
* Gutachten einer sachkundigen Person
